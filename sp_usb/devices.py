      ...
      config_list=[
        {
          ...
          'lang_dict': {
            0x409: {
              'configuration': 'Sprocket ACM Gadget'
            }
          }
        }
      ],
      ...
      config_list=[
        {
          ...
          'lang_dict': {
            0x409: {
              'configuration': 'Sprocket ECM Gadget'
            }
          }
        }
      ],
  ...
  def __init__(self, lun_list=[]):
    ...
    super().__init__(
      config_list=[
        {
          'function_list': [
            MassStorageFunction(lun_list=lun_list)
          ],
          'MaxPower': 250,
          'lang_dict': {
            0x409: {
              'configuration': 'Sprocket Mass Storage'
            }
          }
        }
      ],
      ...
      config_list=[
        {
          ...
          'lang_dict': {
            0x409: {
              'configuration': 'Sprocket RNDIS Gadget'
            }
          }
        }
      ],
